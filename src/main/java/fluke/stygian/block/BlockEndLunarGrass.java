...
public class BlockEndLunarGrass extends Block  implements ITickable {
	public static final String REG_NAME = "endlunargrass";
	private int ticks;
	public BlockEndLunarGrass() {
		...
		setTranslationKey(Reference.MOD_ID + ".endlunargrass");
