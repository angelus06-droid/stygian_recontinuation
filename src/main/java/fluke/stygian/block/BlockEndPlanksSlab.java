...
public abstract class BlockEndPlanksSlab extends BlockSlab {
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
	public static final String REG_NAME = "endplanksslab";

	public BlockEndPlanksSlab(String name) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.endPlanksSlab);
	}
