...
public class BlockEndSnareGrass extends Block  implements ITickable {
	public static final String REG_NAME = "endsnaregrass";
	private int ticks;
	public BlockEndSnareGrass() {
		...
		setTranslationKey(Reference.MOD_ID + ".endsnaregrass");
