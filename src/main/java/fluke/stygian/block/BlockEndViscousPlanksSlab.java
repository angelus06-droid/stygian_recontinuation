...
public abstract class BlockEndViscousPlanksSlab extends BlockSlab {
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
	public static final String REG_NAME = "endviscousplanksslab";

	public BlockEndViscousPlanksSlab(String name) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.endViscousPlanksSlab);
	}
