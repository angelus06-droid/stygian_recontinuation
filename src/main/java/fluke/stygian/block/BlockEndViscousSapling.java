...
public class BlockEndViscousSapling extends BlockBush implements IGrowable {
    public static final String REG_NAME = "endviscoussapling";
    public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);
    protected static final AxisAlignedBB SAPLING_AABB = new AxisAlignedBB(0.1D, 0.0D, 0.1D, 0.9D, 0.8D, 0.9D);

    public BlockEndViscousSapling() {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        WorldGenerator tree = new WorldGenViscousTree(true);
    ...
    protected boolean canSustainBush(IBlockState state) {
        return state.getBlock() == ModBlocks.endSnareGrass;
    }
